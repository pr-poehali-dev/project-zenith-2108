...
const HeroSection = () => {
  ...
  const stats = [
    { icon: "Building2", label: "Типов банков", value: "5+" },
    { icon: "CreditCard", label: "Банковских продуктов", value: "20+" },
    { icon: "TrendingUp", label: "Тем об экономике", value: "30+" },
    { icon: "BookOpen", label: "Понятных объяснений", value: "100+" },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl md:text-2xl mb-8 text-zinc-400 max-w-3xl mx-auto">
              Разбираемся в том, как устроена банковская система — от центрального банка до
              обычного вклада. Просто, понятно и без лишних терминов.
            </p>
            <div className="relative inline-block">
              ...
              >
                <span className="relative z-10">Изучить материалы</span>
                <span
              ...
              >
                <div className="bg-zinc-900/50 rounded-xl p-6 backdrop-blur-lg border border-white/10 transition-all duration-300 hover:scale-105 hover:border-white/20">
                  <div className="mb-2 text-white/70 flex justify-center">
                    <Icon name={stat.icon} size={24} fallback="BookOpen" />
                  </div>
